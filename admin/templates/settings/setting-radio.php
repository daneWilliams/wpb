	...
	<div class="wpb-setting-input"><?php
		...
		?><div class="wpb-setting-choices"><?php
			...
			?><div<?php echo $choice->attr; ?>>
				...
				<input type="radio" id="<?php echo $choice->id ?>" name="<?php echo $choice->name; ?>" value="<?php echo $choice->value; ?>"<?php if ( !empty( $choice->checked ) ) { ?> checked="checked"<?php } ?> />
